<section class="ftco-section">
    ...
    <section class="ftco-section-content">
      ...
      <div class="row-content">
        <?php foreach ($cushion as $obj):  ?>
        <div class="col-product col-md-6">
          <a href="<?= site_url('products/bedding/detail/'. $obj->id .'') ?>">
            <img src="<?= base_url('upload/bedding/cushion/'. $obj->id .'/'. $obj->product_img_1 .'') ?>" class="col-lg-12 content-image">
          </a>
          <div class="title-bottom">
            ...
            <p class="float-right">
              <button class="add_cart btn btn-outline-black" data-productid="<?= $obj->id ?>"
                                                             ...
                                                             data-productqty="1"
                                                             data-productprice="0"
                                                             data-productimg="<?= base_url('upload/bedding/cushion/'. $obj->id .'/'. $obj->product_img_1 .'') ?>">
                                                              Get Quotation
              </button>
            </p>
            <p><?= $obj->mini_detail ?></p>
          ...
          <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-4">
                    <img src="<?= base_url('upload/bedding/cushion/'. $obj->id .'/'. $obj->product_img_1 .'') ?>" class="col-lg-12">
                  </div>
                  <div class="col-md-8">
                    <h2><?= $obj->name ?></h2>
                    <p><?= $obj->full_detail ?></p>
