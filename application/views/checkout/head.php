...
<html lang="en" id="top">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark ftco-navbar bg-dark ftco-navbar-light nav-checkout">
      <div class="navbar-centered">
        <div class="navbar-brand">
          <a href="<?= site_url() ?>">
            <img src="<?= base_url('assets/images/skylinenlogo.png') ?>" alt="Sky Linen" width="155" margin-top="0.5rem" float="center">
          </a>
        </div>
        <i class="icon-arrow-left icon-back btn-back back"></i>
