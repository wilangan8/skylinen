          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://skylinen.co.id" class="f-fallback email-masthead_name">
                <img src="http://skylinen.co.id/assets/images/skylinenlogo.png" width="220px">
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Cheers,
                          <br>The Skylinen Team</p>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">If you’re having trouble with the button above, copy and paste the URL below into your web browser.</p>
                              <p class="f-fallback sub"><a href="http://skylinen.co.id/contact-us">http://skylinen.co.id/contact-us</a></p>
                            </td>
                          </tr>
                        </table>
                      </div>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="content-cell" align="center">
                      <p class="f-fallback sub align-center">&copy; <?= date('Y') ?> Skylinen. All rights reserved.</p>
                      <p class="f-fallback sub align-center">
                        [Skylinen, LLC]
                        <br>Supratman Street No.98 Bandung, Indonesia.
                        <br>Zip Code 40123
                      </p>
                    </td>
                  </tr>
